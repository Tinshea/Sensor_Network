...
public class FGatherTest {
    ...
    void setUp() {
        ...
        sensorDataSet.add(new SensorData("node1",sensorID, 25.5));  // Valeur fictive pour les besoins du test
    ...
    void testEvalReturnsCorrectSensorData() {
        ...
        assertEquals(sensorID, data.getSensorIdentifier(), "L'identifiant du capteur devrait correspondre à celui spécifié.");
