...
public class Register extends AbstractComponent {
	 ...
	 */
	public synchronized boolean registered(String nodeIdentifier) throws Exception {
	...
	private Set<NodeInfoI> calculateNeighbours(NodeInfoI nodeInfo) {
        ...
        final int numberOfCores = this.getTotalNumberOfThreads();
        ExecutorService executor = Executors.newFixedThreadPool(numberOfCores);
        List<Future<Set<NodeInfoI>>> futures = new ArrayList<>();
        // Découpage de registeredNodes en partitions
...
//	private Set<NodeInfoI> calculateNeighbours(NodeInfoI nodeInfo) throws InterruptedException {
//		final Position targetPosition = (Position) nodeInfo.nodePosition();
//		final int numberOfCores = this.getTotalNumberOfThreads();
//		ExecutorService executor = Executors.newFixedThreadPool(numberOfCores);
//		ArrayList<AbstractComponent.AbstractService<Set<NodeInfoI>>> requests =
//				new ArrayList<>();
//		// Découpage de registeredNodes en partitions
//		List<NodeInfoI> nodeList = new ArrayList<>(registeredNodes);
//		int totalNodes = nodeList.size();
...
//			int end = (i == numberOfCores - 1) ? totalNodes : (start + chunkSize);
//			List<NodeInfoI> partition = nodeList.subList(start, end);
//			JOptionPane.showMessageDialog(null, "Propagate flooding has started"+partition, "Information", JOptionPane.INFORMATION_MESSAGE);
//
//			AbstractComponent.AbstractService<Set<NodeInfoI>> request =
//					new AbstractComponent.AbstractService<Set<NodeInfoI>>() {
//						@Override
//						public Set<NodeInfoI> call() throws Exception {
//							return findNeighboursForPartition(partition, nodeInfo, targetPosition);
//						}
//					} ;
...
//		}
//		
//		List<Future<Set<NodeInfoI>>> futures =
...
//	}
	 ...
	 */
	public synchronized void unregister(String nodeIdentifier) throws Exception {
