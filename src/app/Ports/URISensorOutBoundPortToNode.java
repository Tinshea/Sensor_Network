...
public class URISensorOutBoundPortToNode extends AbstractOutboundPort implements SensorNodeP2PCI
{
	private static final long serialVersionUID = 1L;
	
	public	URISensorOutBoundPortToNode(String uri,ComponentI owner) throws Exception {
		super(uri, SensorNodeP2PCI.class, owner) ;
		assert	uri != null && owner != null ;
	}

	public	URISensorOutBoundPortToNode(ComponentI owner) throws Exception {
