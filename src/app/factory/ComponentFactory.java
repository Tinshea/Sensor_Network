 ...
 *
 * <p>Each method in this class utilizes the {@link AbstractComponent#createComponent}
 * method from BCM4Java framework, simplifying the instantiation of components by
 * handling the necessary configuration and initialization details internally.</p>
 */
public class ComponentFactory {

	 /**
     * Creates a new Register component with specified inbound ports.
     * This method initializes a Register component, which acts as a central registry
     * for nodes and clients in the network, facilitating their interaction.
     *
     * @param uriInboundPortNode The URI for the inbound port to receive connections from nodes.
     * @param uriInboundPortClient The URI for the inbound port to receive connections from clients.
    ...
    public static String createRegister(String uriInboundPortNode, String uriInboundPortClient) throws Exception {
        return AbstractComponent.createComponent(
            ...
            new Object[]{uriInboundPortNode, 
            			uriInboundPortClient}
        );
    }
    
    /**
     * Creates a new Client component based on the provided configuration.
     * This method initializes a Client component configured to perform operations
     * as specified in the {@link ClientConfig}. The Client is responsible for sending
    ...
    /**
     * Creates a new Sensor component based on the provided configuration.
     * This method initializes a Sensor component, which represents a single
     * sensor node in the network, capable of gathering and sending sensor data.
     * It is configured according to the {@link SensorConfig}.
     *
