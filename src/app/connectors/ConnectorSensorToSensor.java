 ...
 * peer-to-peer communication between sensor nodes. This connector enables sensor
 * nodes to establish and manage direct connections, execute requests, and handle
 * asynchronous tasks among themselves, promoting effective decentralized network management.
 *
 * This class extends {@link AbstractConnector} and delegates the interaction between
 * sensor nodes through well-defined peer-to-peer communication interfaces.
 */
public class ConnectorSensorToSensor extends AbstractConnector implements SensorNodeP2PCI {
	 ...
	 *
	 * @param neighbour The node information for the neighbor from which disconnection is requested.
	 ...
	 *
	 * @param newNeighbour The node information for the new neighbor with which a connection is sought.
	 ...
	 *
	 * @param requestContinuation The continuation request to be executed asynchronously.
