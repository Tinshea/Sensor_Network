 ...
 * This class implements the {@link NodeInfoI} interface, providing details such as
 * the node identifier, network endpoint information, positional data, and the node's range.
 * Additionally, it handles peer-to-peer endpoint information for network communications.
 */
public class Descriptor implements NodeInfoI {
     ...
     * @param nodePosition The position of the node as a {@link PositionI} object.
     * @param nodeRange The communication or sensor range of the node.
     * @param p2pEndPointInfo The endpoint descriptor for peer-to-peer communications.
     */
     ...
     * @return An {@link EndPointDescriptorI} object containing the endpoint information.
     */
    @Override
     ...
     * @return An {@link EndPointDescriptorI} object for the node's peer-to-peer communications.
     */
    @Override
