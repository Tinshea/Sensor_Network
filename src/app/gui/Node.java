 ...
 * the properties of a node, such as its name and position, and provides functionality
 * to draw itself on a graphical context. It also supports blinking functionality to
 * highlight the node dynamically.
 */
class Node {
    ...
    /**
     * Draws the node on the provided Graphics context. The node is represented
     * as a circle with its name centered. The fill color changes based on its blinking state.
     *
     * @param g The Graphics object on which the node is drawn.
     * @param isOn Indicates whether the blinking effect should show as 'on' or 'off'.
