...
/**
 * Represents a graphical connection between two nodes in a network visualization.
 * This class manages the graphical representation and drawing of a line between two nodes.
 */
class Connection {
    Node start;
    Node end;
