...
/**
 * Represents a graphical light animation between two points in a network visualization.
 * This class manages the movement and drawing of a light-like graphic.
 */
class Light {
    Point position;
    Point start;
    ...
    /**
     * Moves the light towards its endpoint and returns false when it reaches the endpoint.
