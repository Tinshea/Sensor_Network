...
/**
 * The class SBExp must be used to return the boolean value of a sensor, it takes the sensor name to return
 * its value through the eval(ExecutionStateI) methode
 */
